...
export default function SignUp() {
  ...
  const [state,setState] = React.useState(urlState || "signup");
    ...
    return () => {
      ...
      const handleSubmit= async(e)=>{
          ...
          if(!validatePassword(password)){
              showError("Password must be at least 8 characters long and include uppercase, lowercase, a digit and a special character.")
              return;
          }
