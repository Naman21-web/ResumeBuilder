import { FilePenLineIcon, Loader, LoaderCircleIcon, PencilIcon, PlusIcon, TrashIcon, UploadCloud, UploadCloudIcon, XIcon } from 'lucide-react';
...
const Dashboard = () => {
    ...
    const colors = ['#9333ea','#d97706','#dc2626','#0284c7','#16a34a']; // Example colors for resumes
    ...
    const loadAllResumes = async() => {
        // Logic to load all resumes for the user
        try {
