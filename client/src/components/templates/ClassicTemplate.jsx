...
const ClassicTemplate = ({ data, accentColor }) => {
    ...
    // Defensive normalization to avoid rendering objects from AI or backend mistakes
    const summary = typeof data.professional_summary === 'string' ? data.professional_summary : (data.professional_summary?.content ?? '');
